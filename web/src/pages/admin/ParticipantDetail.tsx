        ...
        <div className="min-h-screen bg-background-light dark:bg-background-dark font-display">
            ...
            <main className="max-w-4xl mx-auto px-6 py-8 space-y-6">
                ...
                <div className="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark p-6">
                    ...
                    <div className="text-text-secondary-light mb-4 prose dark:prose-invert max-w-none break-words whitespace-pre-wrap [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:mb-1 [&_p]:mb-3" dangerouslySetInnerHTML={{ __html: mizaj_result.description }} />
                    ...
                    <div className="bg-surface-light dark:bg-surface-dark rounded-xl border border-border-light dark:border-border-dark p-6">
                        ...
                        {mizaj_result.lifestyle_recommendations && (
                            <div>
                                ...
                                <div className="text-text-secondary-light prose dark:prose-invert max-w-none break-words whitespace-pre-wrap [&_ul]:list-disc [&_ul]:pl-5 [&_ol]:list-decimal [&_ol]:pl-5 [&_li]:mb-1 [&_p]:mb-3" dangerouslySetInnerHTML={{ __html: mizaj_result.lifestyle_recommendations }} />
                            </div>
                        )}
                    </div>
                )}
